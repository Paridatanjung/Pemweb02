...
<div id="carouselExampleControls" class="carousel slide" data-bs-ride="carousel">
  <div class="carousel-inner">
    ...
    <div class="carousel-item">
      <img src="/img/beauty.jpg" class="d-block w-100" alt="...">
    </div>
    <div class="carousel-item">
...
<div class="row row-cols-2 row-cols-md-4 g-4 mb-5">
  <div class="col">
    ...
    <a href="" class="btn">
      <img src="/img/skin.jpg" class="card-img-top" alt="">
      <div class="card-body">
  ...
  <div class="col">
    ...
    <a href="/toko/detail" class="btn">
      <img src="/img/ori.jpg" class="card-img-top" alt="">
      <div class="card-body">
  ...
  <div class="col">
    <div class="card h-100">
    <a href="/toko/detail" class="btn">
      <img src="img/ska.jpg" class="card-img-top" alt="">
      <div class="card-body">
